...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if(!Schema::hasTable('invoices')) {
            ...
            $table->enum('invoice_type', ['SALES', 'SERVICE', 'CHARGE', 'COLLECTION RECEIPT', 'OFFICIAL RECEIPT'])->default('SALES')->comment('Invoice type, sales, service, charge, collection receipt, official receipt');
            ...
            $table->enum('status', ['CANCELLED', 'CLOSED', 'OPEN'])->default('OPEN')->comment('Status of the invoice');
            ...
            $table->enum('payment_mode', ['CREDIT', 'CASH'])->default('CASH')->comment('Payment mode, credit or cash');
