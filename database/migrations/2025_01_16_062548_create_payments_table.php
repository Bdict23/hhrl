...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('payments', function (Blueprint $table) {
            ...
            $table->enum('status', ['PARTIAL', 'FULL'])->default('FULL')->comment('Payment status, partial or full');
            $table->enum('payment_method', ['CASH', 'CHEQUE', 'BANK TRANSFER', 'ONLINE'])->default('CASH')->comment('Payment method, cash, cheque, or bank transfer');
            $table->enum('type', ['DOWNPAYMENT', 'SERVICE', 'ITEM', 'OTHERS'])->default('ITEM')->comment('Type of payment, downpayment, service, item, or others');
