...
class ManageEmployees extends Component
{
    ...
    {
        $this->branches = Branch::orderBy('branch_name')->get(['id', 'branch_name'])->where('company_id', auth()->user()->company_id)->where('branch_status', 'ACTIVE');
        $this->departments = Department::orderBy('department_name')->get(['id', 'department_name']); //->where([['company_id', auth()->user()->company_id], ['department_status', 'ACTIVE']]);
        $this->positions = Position::orderBy('position_name')->get(['id', 'position_name'])->where('company_id', auth()->user()->company_id)->where('position_status', 'ACTIVE');
    }
