...
class EquipmentRequestCreate extends Component
{
    ...
    public function fetchData()
    {
        ...
        $this->events = BanquetEvent::with('customer')->where('status', 'CONFIRMED')->where('start_date', '>=', Carbon::now('Asia/Manila')->startOfDay())->where('branch_id', auth()->user()->branch_id)->get();
