...
@section('content')
    <div class="d-flex flex-column">
        ...
        <div class="mb-3 d-md-none text-end">
        ...
        <div class="d-flex">
            ...
            <div class="sidebar d-none d-md-block" style="overflow-y: auto; max-height: 500px;">
                @if (auth()->user()->employee->getModulePermission('Manage Item') != 2)
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item"><a href="#" class="nav-link active btn-sm"
                                onclick="showTab('items-table', this)" style="background-color: #dddddd">Item List</a></li>
                    </ul>
                    <hr>
                @endif
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link btn-sm"
                                onclick="showTab('discount-table', this)">Discounts</a>
                        </li>
                    </ul>
                    <hr>
                @endif
                ...
                @if (auth()->user()->employee->getGroupedModulePermissions('Restaurant Management') != 2)
                    ...
                    <ul class="nav flex-column">
                        ...
                        @if (auth()->user()->employee->getModulePermission('Table Management') != 2)
                            <li class="nav-item"><a href="#" class="nav-link btn-sm"
                                    onclick="showTab('table-lists', this)">Table Management</a></li>
                        @endif

                        @if (auth()->user()->employee->getModulePermission('Menu Controller') != 2)
                            <li class="nav-item"><a href="#" class="nav-link btn-sm"
                                    onclick="showTab('menu-controller-list', this)">Menu Controller</a></li>
                        @endif
                        @if (auth()->user()->employee->getModulePermission('Recipe Pricing') != 2)
                            <li class="nav-item"><a href="#" class="nav-link btn-sm"
                                    onclick="showTab('recipe-pricing-list', this)">Recipe Pricing</a>
                            </li>
                        @endif
                    </ul>
                    <hr>
                ...
                @if (auth()->user()->employee->getGroupedModulePermissions('Business') != 2)
                    ...
                    @if (auth()->user()->employee->getModulePermission('Business Venues') != 2)
                        <ul class="nav flex-column">
                            <li class="nav-item"><a href="#" class="nav-link btn-sm"
                                    onclick="showTab('venue-lists', this)">Venues</a></li>
                        </ul>
                    @endif
                    @if (auth()->user()->employee->getModulePermission('Services') != 2)
                        <ul class="nav flex-column">
                            <li class="nav-item"><a href="#" class="nav-link btn-sm"
                                    onclick="showTab('service-lists', this)">Services</a></li>
                        </ul>
                    @endif
                    @if (auth()->user()->employee->getModulePermission('Cash Drawer') != 2)
                        <ul class="nav flex-column">
                            <li class="nav-item"><a href="#" class="nav-link btn-sm"
                                    onclick="showTab('cash-drawer-lists', this)">Cash Drawers</a></li>
                        </ul>
                    @endif
                    @if (auth()->user()->employee->getModulePermission('Employee') != 2)
                        <ul class="nav flex-column">
                            ...
                            --}}
                            <li class="nav-item"><a href="#" class="nav-link btn-sm"
                                    onclick="showTab('employee-management', this)">Employees</a></li>
                        </ul>
                    @endif
                    @if (auth()->user()->employee->getModulePermission('Employee Positions') != 2)
                        <ul class="nav flex-column">
                            <li class="nav-item"><a href="#" class="nav-link btn-sm"
                                    onclick="showTab('employee-positions', this)">Employees Positions</a></li>
                        </ul>
                    @endif
                    @if (auth()->user()->employee->getModulePermission('Transfer Employee') != 2)
                        <ul class="nav flex-column">
                            <li class="nav-item"><a href="#" class="nav-link btn-sm"
                                    onclick="showTab('transfer-employee', this)">Transfer Employee</a></li>
                        </ul>
                    @endif
                    ...
                    @if (auth()->user()->employee->getModulePermission('Program Settings') != 2)
                        <ul class="nav flex-column">
                            <li class="nav-item"><a href="#" class="nav-link btn-sm"
                                    onclick="showTab('program-settings', this)">Program Settings</a></li>
                        </ul>
                    @endif
                @endif
                @if (auth()->user()->employee->getModulePermission('Import Items') != 2)
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item"><a href="#" class="nav-link btn-sm"
                                onclick="showTab('item-import', this)">Import Items</a></li>
                    </ul>
                @endif
            </div>
            ...
            <!-- Main Content -->
            <div class="overflow-auto content" style="max-height: 600px;">
