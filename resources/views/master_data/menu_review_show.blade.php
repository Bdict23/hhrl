    ...
    <div>
        ...
        <div class="row me-3 w-100">
            <div class=" col-md-8 card">
                <div class=" card-body">
                    <header>
                        <h3>{{ __('REVIEW MENU') }} </h3>
                        <div class="me-3">
                            <x-primary-button data-bs-toggle="modal" data-bs-target="#approveModal">
                                {{ __('Reviewed?') }}
                            </x-primary-button>
                            <x-primary-button data-bs-toggle="modal" data-bs-target="#rejectModal">
                                {{ __('Rework') }}
                            </x-primary-button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to re-prepare this request?
                </div>
    ...
    <div class="modal fade" id="approveModal" tabindex="-1" aria-labelledby="reviewModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to procced this request for approval?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">No</button>
                    <button type="button" class="btn btn-primary" id="confirmReview"
...
@section('script')
    <script>
        ...
        function updateStatusApproved() {
            fetch('{{ url('/menu_reviewed/' . $menus->id) }}', {
                    method: 'POST',
                    headers: {
