    ...
    <div class="container mt-4">
        <ul class="nav nav-tabs" id="jobOrderTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="invoice-tab" data-bs-toggle="tab" data-bs-target="#invoice" type="button"
                    role="tab" aria-controls="invoice" aria-selected="true">Menu</button>
            </li>
            <li class="nav-item" role="presentation">
        ...
        <div class="tab-content" id="jobOrderTabContent">
            <div class="tab-pane fade show active" id="invoice" role="tabpanel" aria-labelledby="invoice-tab">
                ...
                <div class="dashboard">
                    <header>
                        <h2>Food Menu Review Request</h2>
                        ...
                        <tbody>
                            @foreach ($menus as $menu)
                                <tr>
                                    ...
                                    <td>{{ $menu->preparer->name }}</td>
                                    <td>{{ $menu->reviewer->name ?? 'Not Assigned' }}</td>
                                    <td>{{ $menu->created_at->format('m/d/Y') }}</td>

                                    <td>
                                        <a class="btn btn-primary btn-sm" href="{{ route('menu_review_show', $menu->id) }}">
