<div id="items-cost" class="tab-content card">
    ...
    document.addEventListener('livewire:init', () => {
        const chartManager = (() => {
            ...
            const chartConfig = {
                ...
                options: {
                    ...
                    scales: {
                        x: { title: { display: true, text: 'Date', color: '#6b7280' }, grid: { color: 'rgba(229, 231, 235, 0.5)' } },
                        y: { 
        ...
        // Handle supplier form submission via AJAX
        window.saveSupplier = function() {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    // Refresh the supplier list and select the new supplier
