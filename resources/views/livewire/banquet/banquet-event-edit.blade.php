                ...
                <div class="card-body">
                   ...
                   <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            @forelse ($eventDetails->eventServices as $index => $service )
                                <tr>
                    ...
                    <div class="card-body">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                @forelse ($eventDetails->eventMenus as $index => $menus)
                                    <tr>
                                        <td>{{ $menus->menu->menu_name }}</td>
                                        <td>{{ $menus->menu->categories->category_name }}</td>
                                        <td>{{ $menus->menu->mySRP->amount ?? 'FREE' }}</td>
                                        <td>
                                        ...
                                        <td class="total-price-menu">{{ isset($menus->menu->mySRP) && isset($menusAdded[$index]['qty']) ? ($menusAdded[$index]['qty'] * $menus->menu->mySRP->amount) : '-' }}</td>
                                        <td>
