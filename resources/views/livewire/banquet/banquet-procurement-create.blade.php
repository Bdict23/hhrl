    ...
    <div class="mb-2 row">
        <div class="col-md-6 row">
            ...
            <div class="col-md-6 justify-content-center d-flex">
                <div class="container">
                    <a type="button" href="{{ route('banquet.procurement.summary') }}"
                        class="btn btn-secondary input-group-text">Summary &nbsp;<i class="bi bi-list-columns"></i></a>
                </div>
                <div class="container">
                    @if ($bebId && !$isNewRequest && $isFinal == 'APPROVED')
                        <a href="/banquet-event-budget-print?beb-id={{ $bebId }}"
                            class="btn btn-info input-group-text">Print Preview &nbsp;<i class="bi bi-printer"></i></a>
                    @endif
                </div>
            </div>
        </div>
                ...
                <div class="card ">
                    <div class="card-body">
                        <form id="banquetProcurementForm" action="" wire:submit.prevent='storeRequestBudget'>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="document_number" class="form-label form-control-sm">Document
                                        Number</label>
                                    <input type="text" class="form-control form-control-sm" id="document_number"
                                        name="document_number" wire:model="documentNumber">
                                    @error('documentNumber')
                                        <div class="text-xs text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-6">
                                    <label for="reference_number" class="form-label form-control-sm">Reference
                                        Number</label>
                                    <input type="text" class="form-control form-control-sm" id="reference_number"
                                        name="reference_number" placeholder="<AUTO>"
                                        value="{{ $requestReferenceNumber }}" disabled>
                                </div>
                            </div>
                            <div class="mb-2 row">
                                <div class="col-md-6">
                                    <label for="cust_name" class="form-label form-control-sm">Customer Name</label>
                                    <input type="text" class="form-control form-control-sm" id="event_name"
                                    ...
                                    <div class="input-group">
                                        ...
                                        @if ($isNewRequest)
                                            <button class="input-group-text" type="button"
                                                ...
                                                data-bs-target="#getEventModal"><strong
                                                    class="text-sm">Get</strong></button>
                                        @endif
                                    </div>
                            ...
                            <div class="mb-2 row">
                                <div class="col-md-6">
                                    ...
                                    <input disabled type="date" class="form-control form-control-sm"
                                        ...
                                        value="{{ isset($selectedEvent) ? $selectedEvent->start_date : '' }}"
                                        required>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input disabled type="time" class="form-control form-control-sm"
                                        id="event_time" name="event_time"
                                        value="{{ isset($selectedEvent) ? $selectedEvent->arrival_time : '' }}"
                                        required>
                                </div>
                                <div class="col-md-6">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm"
                                                    wire:model.live='requestedBudget'
                                                    placeholder="Requested Budget Amount">
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                <input type="number" class="form-control form-control-sm"
                                                    placeholder="Percentage" wire:model.live='totalPercentage'>
                                                <span class="input-group-text">%</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select name="reviewed_by" id="reviewed_by"
                                            class="form-select form-select-sm" wire:model='selectedReviewer'>
                                            <option class="text-xs" value="">Select Reviewer</option>
                                            @foreach ($reviewers as $reviewer)
                                                <option class="text-xs" value="{{ $reviewer->employees->id }}"
                                                    {{ isset($selectedEvent) && $selectedEvent->reviewed_by == $reviewer->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="approved_by" id="approved_by"
                                            class="form-select form-select-sm" wire:model='selectedApprover'>
                                            <option class="text-xs" value="">Select Approver</option>
                                            @foreach ($approvers as $approver)
                                                <option class="text-xs" value="{{ $approver->employees->id }}"
                                                    {{ isset($selectedEvent) && $selectedEvent->approved_by == $approver->id ? 'selected' : '' }}>
                                ...
                                <div class="mt-2 row">
                                    <div class="col-md-12">
                                        <textarea class="form-control" name="notes" id="" cols="30" rows="3" wire:model='notes'
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-sm">
                                                        <input id="grossOrder" type="text"
                                                            ...
                                                            value="₱ {{ number_format($totalGrossOrder, 2) }}"
                                                            disabled>
                                                        <br>
                                                    </td>
                                                </tr>
                            ...
                            @forelse ($events as $event)
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($event->start_date)->format('M. d, Y') }}
                                        ({{ \Carbon\Carbon::parse($event->arrival_time)->format('h:i A') }})
                                    </td>
                                    <td>{{ \Carbon\Carbon::parse($event->end_date)->format('M. d, Y') }}
                                        ({{ \Carbon\Carbon::parse($event->departure_time)->format('h:i A') }})</td>
                                    ...
                                    <td>
                                        <button wire:click="loadEventDetails({{ $event->id }})"
                                            ...
                                            <span wire:loading
                                                wire:target="loadEventDetails({{ $event->id }})"><span
                                                    class="spinner-border spinner-border-sm" role="status"
                                                    aria-hidden="true"></span> Wait..</span>
                                            <span wire:loading.remove
                                                wire:target="loadEventDetails({{ $event->id }})">Select</span>
                                        </button>
                                    </td>
                                </tr>
                            @empty
