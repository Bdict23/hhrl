        ...
        <div class="col-md-8 card mb-3">
            <div class=" card-body">
                <header>
                    <h1>ORDERS</h1>
                    <div class="me-3">
                        <x-primary-button onclick="history.back()" type="button"> Back
                        </x-primary-button>
                    </div>
                </header>
                <div class="row me-3">
                    <div class="col-md-6">
                        <div class="input-group input-group-sm input-group-solid">
                            <input wire:model="search" type="text" class="form-control" id="customerName"
                                name="customerName" placeholder="Search Order Number">
                    ...
                    <tbody id="itemTableBody">
                        @forelse ($orders as $order)
                            <tr onclick="selectOrder(this)" data-order-id="{{ $order->id }}"
                                ...
                                <td class="text-center" style="font-size: smaller;">{{ $order->total_order }}</td>
                                <td class="text-center" style="font-size: smaller;">{{ $order->total_price }}</td>
                            </tr>
                        @empty
                            <tr>
                ...
                <form action="{{ route('allocate-order') }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="table" wire:model="table">
                    ...
                    <div class="card-footer text-end">
                        <button class="btn btn-secondary" wire:click="cancelOrder">Cancel</button>
