<div>
    ...
    <div id="sub-classification-table" class="tab-content card" style="display: none" wire:ignore.self>
                                    ...
                                    @if (auth()->user()->employee->getModulePermission('Item Sub-Classifications') == 1)
                                        <td class="text-end">
                                            <button type="button" class="btn btn-sm btn-primary"
                                                onclick="UpdateSubClassField({{ json_encode($sub_classification) }})"
                                                data-bs-toggle="modal" data-bs-target="#UpdateSubClass"
                                                wire:click="editSubClassification({{ $sub_classification->id }})">Edit</button>
                                            <a href="#" class="btn btn-sm btn-danger"
                                                wire:click="deactivate({{ $sub_classification->id }})">Delete</a>
                                        </td>
                                    @endif
                                </tr>
                            @empty
            ...
            <div class="card-body">
                ...
                <form wire:submit.prevent="store">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="sub-classification_name-input" class="form-label">Sub Classification Name
                    ...
                    <div class="mb-3">
                        <label for="sub-classification_description-input" class="form-label">Description <span
                                style="color: red;">*</span></label>
                        <textarea class="form-control" id="sub-classification_description-input" wire:model="classification_description"
                            rows="3"></textarea>
                    </div>
        ...
        <div class="modal fade" id="UpdateSubClass" tabindex="-1" aria-labelledby="updateCategoryModal"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-12">
                                ...
                                <input type="text" class="form-control" id="subclass_name-update-input"
                                    wire:model="classification_name">
                                @error('classification_name')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="mb-3 ">
                            ...
                            <textarea class="form-control" id="subclass_description-update-input" wire:model="classification_description"
                                rows="3"></textarea>
                        ...
                        <x-primary-button type="button"
                            wire:click="updateSubClassification">Update</x-primary-button>
                    </div>
                </div>
            </div>
        </div>
