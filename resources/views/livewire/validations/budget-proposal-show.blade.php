<div>
    ...
    <div class="mb-2 row">
        <div class="col-md-6 row">
            ...
            <div class="col-md-6 justify-content-center d-flex">
                <div class="container">
                    <a type="button" href="/budget-proposal-approval-lists"
                        class="btn btn-secondary input-group-text">Summary</a>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <label class="form-check-label" for="addServiceToGross">Add to Gross
                                            Amount</label>
                                        <input class="form-check-input" type="checkbox" id="addServiceToGross"
                                            wire:model.live="hasServices" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div>
                <div class="card ">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <label for="document_number" class="text-xs form-label">Document Number</label>
                                <input type="text" class="text-xs form-control form-control-sm" id="document_number"
                                    name="document_number" wire:model="documentNumber" disabled>
                                @error('documentNumber')
                                    <div class="text-xs text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                <label for="reference_number" class="text-xs form-label">Reference Number</label>
                                <input type="text" class="text-xs form-control form-control-sm" id="reference_number"
                                    name="reference_number" placeholder="<AUTO>" value="{{ $requestReferenceNumber }}"
                                    disabled>
                            </div>
                        </div>
                        <div class="mb-2 row">
                            <div class="col-md-6">
                                <label for="cust_name" class="text-xs form-label">Customer Name</label>
                                <input type="text" class="text-xs form-control form-control-sm" id="event_name"
                                    name="event_name" disabled
                                    value="{{ isset($selectedEvent->customer) ? $selectedEvent->customer->customer_fname . ' ' . $selectedEvent->customer->customer_lname : '' }}">
                            </div>
                            <div class="col-md-6">
                                <label for="event_name" class="text-xs form-label">Event Name</label>
                                <input type="text" class="text-xs form-control form-control-sm" id="event_name"
                                    name="event_name" disabled
                                    value="{{ isset($selectedEvent) ? $selectedEvent->event_name : '' }}">
                        ...
                        <div class="mb-2 row">
                            <div class="col-md-6">
                                <label for="event_date" class="text-xs form-label">Start Date</label>
                                <input disabled type="date" class="text-xs form-control form-control-sm"
                                    id="event_date" name="event_date"
                                    value="{{ isset($selectedEvent) ? $selectedEvent->start_date : '' }}" required>
                            </div>
                            <div class="col-md-6">
                                <label for="event_date" class="text-xs form-label">End Date</label>
                                <input disabled type="date" class="text-xs form-control form-control-sm"
                                    id="event_date" name="event_date"
                                    value="{{ isset($selectedEvent) ? $selectedEvent->end_date : '' }}" required>
                            </div>

                            <div class="col-md-6">
                                <label for="event_time" class="text-xs form-label">Arrival Time</label>
                                <input disabled type="time" class="text-xs form-control form-control-sm"
                                    id="event_time" name="event_time"
                                    value="{{ isset($selectedEvent) ? $selectedEvent->arrival_time : '' }}" required>
                            </div>
                            <div class="col-md-6">
                                <label for="event_time" class="text-xs form-label">Departure Time</label>
                                <input disabled type="time" class="text-xs form-control form-control-sm"
                                    id="event_time" name="event_time"
                                    value="{{ isset($selectedEvent) ? $selectedEvent->departure_time : '' }}"
                                    required>
                            </div>

                            <div class="mb-2 row">
                                <div class="mt-2 mb-2 col-md-12 row">
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            <span class="input-group-text">₱</span>
                                            <input disabled type="text" class="form-control form-control-sm"
                                                value="{{ $requestedBudget ? number_format($requestedBudget, 2) : '' }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            <input disabled type="number" class="form-control form-control-sm"
                                                ...
                                                value="{{ $requestedBudget && $totalGrossOrder > 0 ? number_format(($requestedBudget / $totalGrossOrder) * 100, 2) : null }}">
                                            <span class="input-group-text">%</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="event_description" class="text-xs form-label">Reviewed By</label>
                                    <input type="text" class="text-xs form-control" id="reviewed_by"
                                        name="reviewed_by" disabled value="{{ $selectedReviewer }}">
                                </div>
                                <div class="col-md-6">
                                    <label for="guest_count" class="text-xs form-label">Approved By</label>
                                    <input type="text" class="text-xs form-control" id="approved_by"
                                        name="approved_by" disabled value="{{ $selectedApprover }}">
                                </div>
                            </div>
                            <div class="mt-2 row">
                                <div class="col-md-12">
                                    <label for="notes" class="text-xs form-label">Notes <span
                                            style="font-size: x-small">(optional)</span></label>
                                    ...
                                    <table class="table table-striped">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">
                                                    <input id="grossOrder" type="text"
                                                        class="form-control form-control-sm"
                                                        value="₱ {{ number_format($totalGrossOrder, 2) }}" disabled>
                                                    <br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <strong>
                                                        Allocated Budget
                                                        {{ $totalPercentage ? number_format($totalPercentage, 2) : 0 }}%
                                                    </strong>
                                                <td>
                                                    <input type="text" id="allocatedBudget"
                                                        class="form-control form-control-sm" disabled
                                                        value="₱  {{ number_format($requestedBudget, 2) }} ">
                                                </td>
                                                </td>
                                            </tr>
                                        </tbody>
    ...
    <!-- Get Event Modal -->
    <div class="modal fade" id="getEventModal" tabindex="-1" aria-labelledby="getEventModalLabel"
                        ...
                        <tbody>
                            @forelse ($events as $event)
                                <tr>
                                    ...
                                    <td>{{ $event->customer->customer_fname . ' ' . $event->customer->customer_lname }}
                                    </td>
                                    <td>{{ $event->guest_count }}</td>
                                    <td>{{ $event->venue->venue_name }}</td>
                                    <td>
                                        <button wire:click="loadEventDetails({{ $event->id }})"
