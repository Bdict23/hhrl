<div class="overflow-x-auto">
   ...
   <div class="d-flex justify-content-between">
     <div class="w-50">
       ...
       <h4 class="text-end">For Approval Summary <i class="bi bi-list-task"></i></h4>
   </div>
                            ...
                            @forelse ($batches ?? [] as $batch)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a style="text-decoration: none" href="{{ route('assets.approval.show', ['id' => $batch->id , 'action' => 'approval']) }}">
