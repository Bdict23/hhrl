<div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    @endif
                    <x-secondary-button type="button" class="mb-3 btn-sm" wire:click="fetchCashDrawerData()">
                        <span wire:loading.remove wire:target="fetchCashDrawerData()">Refresh</span>
                        <span wire:loading wire:target="fetchCashDrawerData()"><span
                    ...
                    <thead class="table-dark sticky-top">
                        <tr>
                            ...
                            <th class="text-xs text-center"
                                @if (auth()->user()->employee->getModulePermission('Cash Drawer') != 1) style="display: none;" @endif>ACTIONS</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($cashDrawers ?? [] as $cashDrawer)
                            <tr>
                                ...
                                <td class="text-xs">
                                    {{ $cashDrawer->department ? $cashDrawer->department->department_name : 'N/A' }}
                                </td>
                                <td class="text-xs text-end"
                                    @if (auth()->user()->employee->getModulePermission('Cash Drawer') != 1) style="display: none;" @endif>
                                    <x-secondary-button class="btn-sm"
                                        wire:click="editCashDrawer({{ $cashDrawer->id }})" data-bs-toggle="modal"
                                        data-bs-target="#UpdateDrawer"><i
                                            class="bi bi-pencil-square"></i>&nbsp;Edit</x-secondary-button>
                                    <x-danger-button class="btn-sm"
                                        wire:click="deactivateCashDrawer({{ $cashDrawer->id }})"><i
                                            class="bi bi-slash-circle"></i>&nbsp;Disable</x-danger-button>
                                </td>
                            </tr>
                        @empty
                            {{-- If no services found --}}
                            <tr>
                                <td colspan="7" class="text-center text-muted">No drawers found. &nbsp;<i
                                        class="bi bi-dropbox"></i></td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <div class="modal fade" id="UpdateDrawer" tabindex="-1" aria-labelledby="updateDrawerModal" aria-hidden="true"
        wire:ignore.self>
                    ...
                    <form action="" wire:submit.prevent="updateDrawer" id="UpdateDrawerForm">
                        <div class="row">
                            <div class="mb-3 col-md-12">
                                ...
                                <input type="text" class="form-control" id="drawer_name-update-input"
                                    wire:model="drawer_name_input">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="drawer_code-update-input"
                                        wire:model="drawer_code_input">
                        ...
                        <div class="mb-3 ">
                            <label for="department-select" class="form-label">Department <span
                        ...
                        <x-primary-button type="submit"><i
                                class="bi bi-arrow-counterclockwise"></i>&nbsp;Update</x-primary-button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div id="cash-drawer-form" class="tab-content card" style="display: none;" wire:ignore.self>
        ...
        <div class="card-body">
            ...
            <form wire:submit.prevent="storeCashDrawer" id="cashDrawerForm">
                ...
                <div class="mb-3 row">
                    <div class="col-md-4">
                        <label for="drawer_name-input" class="form-label">Drawer Name <span
                                style="color: red;">*</span></label>
                        <input type="text" class="form-control" id="drawer_name-input"
                            wire:model="drawer_name_input">
                        @error('drawer_name_input')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                ...
                <div class="mb-3 row">
                    <div class="mb-6 col-md-4">
                        <label for="drawer_code-input" class="form-label">Drawer Code <span
                                style="color: red;">*</span></label>
                        <input type="text" class="form-control" id="drawer_code-input"
                            wire:model="drawer_code_input">
                        @error('drawer_code_input')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
