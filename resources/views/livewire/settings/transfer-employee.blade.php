<div>
    ...
    <div id="transfer-employee" class="tab-content card" style="display: none;" wire:ignore.self>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <x-secondary-button type="button" class=" btn-sm" wire:click="fetchData()">
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Search Employee" onkeyup="filterTable()"
                            id="search-input" aria-label="Search" aria-describedby="basic-addon1">
                    </div>
                    <script>
                        ...
                        @forelse ($employees ?? [] as $employee)
                            <tr>
                                ...
                                <td
                                    ...
                                    {{ $employee->position->position_name ?? 'N/A' }}</td>
                                ...
                                @if (auth()->user()->employee->getModulePermission('Transfer Employee') == 1)
                                    <td class="text-end">
                                        <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                            ...
                                            onclick="updateCategory({{ json_encode($employee) }})"
                                            wire:click="selectEmployee({{ $employee->id }})">Transfer</button>
                                    </td>
                                @endif
                            </tr>
    ...
    {{-- Modal --}}
    <div class="modal fade" id="transferEmployeeModal" tabindex="-1" aria-labelledby="updateCategoryModal"
                    ...
                    <form action="" wire:submit.prevent="confirmTransferEmployee">
                        <div class="row">
                            <div class="mb-3 col-md-12">
                                ...
                                <input
                                    value="{{ ($selectedEmployee->name ?? '') . ' ' . ($selectedEmployee->middle_name ?? '') . ' ' . ($selectedEmployee->last_name ?? '') }}"
                                    type="text" class="form-control" id="category_name-update-input" readonly>
                            ...
                            <div class="mb-3 ">
                                ...
                                <select class="form-control" id=""
                                    wire:change="fetchBranches($event.target.value)">
