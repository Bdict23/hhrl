<div>
            ...
            <div class="row">
                <div class="col-md-6">
                    @if (auth()->user()->employee->getModulePermission('Services') == 1)
                        <x-primary-button type="button" class="mb-3 btn-sm"
                            onclick="showTab('service-form', document.querySelector('.nav-link.active'))"
                ...
                <div class="col-md-6">
                    <div class="mb-3 input-group">
                        ...
                        <input type="text" class="form-control" id="search-service" onkeyup="filterServices()">
                    </div>
                </div>
            </div>
            <script>
                ...
                <table class="table table-striped table-sm small">
                    <thead class="table-dark sticky-top">
                        <tr>
                            ...
                            <th class="text-xs text-end"
                                @if (auth()->user()->employee->getModulePermission('Services') != 1) style="display: none;" @endif>ACTIONS</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($services ?? [] as $service)
                            <tr>
                                ...
                                <td class="text-xs">{{ $service->category ? $service->category->category_name : 'N/A' }}
                                </td>
                                <td class="text-xs">
                                ...
                                <td class="text-xs text-end whitespace-nowrap"
                                    @if (auth()->user()->employee->getModulePermission('Services') != 1) style="display: none;" @endif>
                                    <x-secondary-button class="btn-sm" wire:click="editService({{ $service->id }})"
                                        onclick="updateService({{ json_encode($service) }})" data-bs-toggle="modal"
                                        data-bs-target="#UpdateService">Edit</x-secondary-button>
                                    <x-danger-button class="btn-sm"
                                        wire:click="deactivateService({{ $service->id }})">remove</x-danger-button>
                                </td>
                            </tr>
                        @empty
    ...
    <div class="modal fade" id="UpdateService" tabindex="-1" aria-labelledby="updateServiceModal" aria-hidden="true"
        wire:ignore.self>
                    ...
                    <form action="" wire:submit.prevent="updateService" id="UpdateServiceForm">
                        <div class="row">
                            <div class="mb-3 col-md-12">
                                ...
                                <input type="text" class="form-control" id="service_name-update-input"
                                    wire:model="service_name_input">
                        ...
                        <div class="row">
                            <div class="mb-3 row col-md-12">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select name="" id="selectServiceTypeUpdate" class="form-control"
                                        wire:model="service_type_input">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="input-group">
                                        <select name="" id="selectServiceCategoryUpdate" class="form-control"
                                        ...
                                        <button type="button" style="background-color: rgb(190, 243, 217);"
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="service_code-update-input"
                                        wire:model="service_code_input">
                                ...
                                <div class="mb-3 col-md-6">
                                    <label for="service_rate-input-update" class="form-label">Rate Price <span
                                            style="color: red;">*</span></label>
                                    <div class="mb-2 input-group">
                                        <input type="number" step="0.01" class="form-control"
                                            id="service_rate-input-update" wire:model="service_rate_input"
                                            @if ($isFree) disabled @endif placeholder="0.00">
                                        <div class="input-group-text" style="background-color: rgb(230, 225, 225)">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox"
                                                    id="service-multiplier-update"
                                                    wire:model="service_multiplier_input">
                                                <label class="text-xs form-check-label"
                                                    for="service-multiplier-update"><strong>Multiplier</strong></label>
                                            </div>
                                        </div>
                                    ...
                                    <x-checkbox id="label" label="Free" wire:model.live="isFree" />
                            ...
                            @if ($service_type_input == 'EXTERNAL')
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="number" step="0.01" class="form-control"
                                        id="service_cost-update-input" wire:model="service_cost_input">
                        ...
                        <div class="mb-3 ">
                            ...
                            <textarea class="form-control" id="service_description-update-input" wire:model="service_description_input"
                                rows="3"></textarea>
    ...
    <div id="service-form" class="tab-content card" style="display: none;" wire:ignore.self>
        ...
        <div class="card-body">
            ...
            <form wire:submit.prevent="storeService" id="serviceForm">
                ...
                <div class="mb-3 row">
                    <div class="col-md-4">
                        <label for="service_name-input" class="form-label">Service Name <span
                                style="color: red;">*</span></label>
                        <input type="text" class="form-control" id="service_name-input"
                            wire:model="service_name_input">
                        @error('service_name_input')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-md-4">
                        <label for="service-category" class="form-label">Category <span
                                style="color: red;">*</span></label>
                        <div class="input-group">
                            ...
                            <button type="button" style="background-color: rgb(190, 243, 217);"
                                class="input-group-text" data-bs-toggle="modal" data-bs-target="#addCategoryModal">
                                Add
                            </button>
                        </div>
                    ...
                    <div class="col-md-4">
                        <label for="service_type-input" class="form-label">Service Type <span
                                style="color: red;">*</span></label>
                        <select name="" id="service_type-input" class="form-control"
                            wire:model.live="service_type_input">
                            <option value="">Select</option>
                            <option value="INTERNAL">Internal</option>
                            <option value="EXTERNAL">External</option>
                        </select>
                ...
                <div class="mb-3 row">
                    <div class="mb-6 col-md-4">
                        <label for="service_code-input" class="form-label">Service Code <span
                                style="color: red;">*</span></label>
                        <input type="text" class="form-control" id="service_code-input"
                            wire:model="service_code_input">
                        @error('service_code_input')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="mb-6 mr-3 col-md-4">
                        <label for="service_rate" class="form-label">Rate Price <span
                                style="color: red;">*</span></label>
                        <div class="mb-2 input-group">
                            <input type="number" step="0.01" class="form-control" id="service_rate"
                                wire:model="service_rate_input" @if ($isFree) disabled @endif
                                placeholder="0.00">
                            <div class="input-group-text" style="background-color: rgb(230, 225, 225)">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="service-multiplier"
                                        wire:model="service_multiplier_input">
                                    <label class="text-xs form-check-label"
                                        for="service-multiplier"><strong>Multiplier</strong></label>
                                </div>
                            </div>
                            @error('service_rate_input')
                                <span class="text-danger">{{ $message }}</span>
                    ...
                    @if ($service_type_input == 'EXTERNAL')
                        <div class="mb-6 col-md-4">
                            ...
                            <input type="number" step="0.01" class="form-control" id="service_cost-input"
                                wire:model="service_cost_input">
                            @error('service_cost_input')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    @endif
                    <div class="mb-3">
                        <label for="service_description-input" class="form-label">Description <span
                                style="color: red;">*</span></label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="storeServiceCategory" id="addCategoryForm">
                        <div class="mb-3">
                            <label for="service_category_input" class="form-label">Category Name <span
                                    style="color: red;">*</span></label>
                            <input type="text" class="form-control" id="service_category_input"
                                wire:model="service_category_add_input">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="service_category_description_input"
                                wire:model="service_category_description_input" rows="3"></textarea>
