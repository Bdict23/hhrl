<div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3 input-group">
                        ...
                        <input type="text" class="form-control" id="search-table" onkeyup="filterTables()">
                    </div>
                </div>
            </div>
            <script>
                                ...
                                @if (auth()->user()->employee->getModulePermission('Business Venues') == 1)
                                    <td class="text-end">
                                        <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                            ...
                                            onclick="updateTable({{ json_encode($table) }})"
                                            wire:click="editTable({{ $table->id }})">Edit</button>
                                        <a href="#" class="btn btn-sm btn-danger"
                                            wire:click="deactivateTable({{ $table->id }})">Remove</a>
                                    </td>
                                @endif
                            </tr>
                        @empty
    ...
    {{-- Update Modal --}}
    <div class="modal fade" id="updateTableModal" tabindex="-1" aria-labelledby="updateMenuCategory" aria-hidden="true"
        wire:ignore.self>
                    ...
                    <form action="" wire:submit.prevent="updateTable" id="UpdateTableForm">
                        <div class="row">
                            <div class="mb-3 col-md-12">
                                ...
                                <input type="text" class="form-control" id="table_name-update-input"
                                    wire:model="table_name_input">
                        ...
                        <div class="mb-3 ">
                            ...
                            <input type="number" class="form-control" id="table_capacity-update-input"
                                wire:model="table_capacity_input">
    ...
    <div id="table-create-form" class="tab-content card" style="display: none;" wire:ignore.self>
        ...
        <div class="card-body">
            ...
            <form wire:submit.prevent="storeTable" id="tableForm">
                @csrf
                <div class="mb-3">
                    <label for="table_name-input" class="form-label"> Table Name <span
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="table_capacity-input"
                        wire:model="table_capacity_input">
                    @error('table_capacity_input')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
