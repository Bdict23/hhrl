<div>
                ...
                <div class="col-md-6">
                    @if (auth()->user()->employee->getModulePermission('Unit Conversions') == 1)
                        <x-primary-button type="button" class="mb-3 btn-sm"
                            onclick="showTab('unit-conversion-form', document.querySelector('.nav-link.active'))">+ Add
                            Unit Conversion</x-primary-button>
                    @endif
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <x-secondary-button type="button"
                                        wire:click="edit({{ $uom->id }})">Edit</x-secondary-button>
                                    <x-danger-button type="button"
                                        wire:click="delete({{ $uom->id }})">Delete</x-danger-button>
                                </td>
                            </tr>
                        @empty
    ...
    <div id="unit-conversion-form" class="tab-content card" style="display: none" wire:ignore.self>
        ...
        <div class="card-body">
            ...
            <form wire:submit.prevent="storeUnitConversion" id="unit_conversion-form">
                ...
                <div class="mb-3">
                    <label for="sub-classification_description-input" class="form-label">Conversion Factor <span
                            style="color: red;">*</span></label>
                    <input type="number" class="form-control" id="sub-classification_description-input"
                        wire:model="conversionFactor" step="any" min="0.001"
    ...
    <div class="modal fade" id="UpdateSubClass" tabindex="-1" aria-labelledby="updateCategoryModal" aria-hidden="true"
        wire:ignore.self>
