<div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    @endif
                    <x-secondary-button type="button" class="mb-3 btn-sm" wire:click="fetchVenues()">
                        <span wire:loading.remove wire:target="fetchVenues()">Refresh</span>
                        <span wire:loading wire:target="fetchVenues()"><span
                ...
                <div class="col-md-6">
                    <div class="mb-3 input-group">
                        ...
                        <input type="text" class="form-control" id="search-venue" onkeyup="filterVenues()">
                    </div>
                </div>
            </div>
            <script>
                        ...
                        @forelse ($venues ?? [] as $venue)
                            <tr>
                                ...
                                <td
                                    ...
                                    {{ $venue->description ?? 'N/A' }}</td>
                                <th>{{ $venue->capacity }}</th>
                                <td>{{ $venue->ratePrice ? '₱' . number_format($venue->ratePrice->amount, 2) : 'N/A' }}
                                </td>
                                @if (auth()->user()->employee->getModulePermission('Item Categories') == 1)
                                    <td class="text-end">
                                        <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#UpdateVenue"
                                            onclick="updateVenue({{ json_encode($venue) }})"
                                            wire:click="editVenue({{ $venue->id }})">Edit</button>
                                        <a href="#" class="btn btn-sm btn-danger"
                                            wire:click="deactivate({{ $venue->id }})">remove</a>
                                    </td>
                                @endif
                            </tr>
                        @empty
    ...
    {{-- Update Modal --}}
    <div class="modal fade" id="UpdateVenue" tabindex="-1" aria-labelledby="updateVenueModal" aria-hidden="true"
        wire:ignore.self>
                    ...
                    <form action="" wire:submit.prevent="updateVenue" id="UpdateVenueForm">
                        <div class="row">
                            <div class="mb-3 col-md-12">
                                ...
                                <input type="text" class="form-control" id="venue_name-update-input"
                                    wire:model="venue_name_input">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="venue_code-update-input"
                                        wire:model="venue_code_input">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="number" class="form-control" id="capacity-update-input"
                                        wire:model="capacity_input">
                                    @error('capacity_input')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="mb-3 col-md-4">
                                    <label for="venue_rate-update" class="form-label">Rate <span
                                            class="text-danger">*</span></label>
                                    <input type="number" step="0.01" class="form-control"
                                        id="venue_rate-update-input" wire:model="venue_rate_input">
                        ...
                        <div class="mb-3 ">
                            ...
                            <textarea class="form-control" id="venue_description-update-input" wire:model="venue_description_input"
                                rows="3"></textarea>
    ...
    <div id="venue-form" class="tab-content card" style="display: none;" wire:ignore.self>
        ...
        <div class="card-body">
            ...
            <form wire:submit.prevent="storeVenue" id="venueForm">
                @csrf
                <div class="mb-3">
                    <label for="venue_name-input" class="form-label">Venue Name <span
                ...
                <div class="mb-3 row">
                    <div class="mb-3 col-md-4">
                        <label for="venue_code-input" class="form-label">Venue Code <span
                                style="color: red;">*</span></label>
                        <input type="text" class="form-control" id="venue_code-input"
                            wire:model="venue_code_input">
                        @error('venue_code_input')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="mb-3 col-md-4">
                        <label for="capacity-input" class="form-label">Capacity <span
                                style="color: red;">*</span></label>
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <input type="number" step="0.01" class="form-control" id="venue_rate-input"
                            wire:model="venue_rate_input">
                        @error('venue_rate_input')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="mb-3">
                    <label for="venue_description-input" class="form-label">Description <span
                            style="color: red;">*</span></label>
                    <textarea class="form-control" id="venue_description-input-update" wire:model="venue_description_input"
                        rows="3"></textarea>
