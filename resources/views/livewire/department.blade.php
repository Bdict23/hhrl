                                ...
                                <tr style="font-size: smaller;">
                                    ...
                                    <td>
                                        <button class="btn btn-primary btn-sm" wire:click="edit({{ $department->id }})"
                                            onclick="showTab('department-update-form', this), changeModule('UPDATE-MODULE', '{{ $department->department_name }}', '{{ $department->department_description }}' )">Edit</button>
                                ...
                                <div class="alert alert-light" role="alert">
                                    <div class="row">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="description2" wire:model="description"></textarea>
                                            @error('description')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        window.addEventListener('saved', event => {
            let element = document.getElementById('department_name');
            let element2 = document.getElementById('department_name2');
            let element3 = document.getElementById('description');
            let element4 = document.getElementById('description2');
            element.value = '';
            element2.value = '';
            element3.value = '';
            element4.value = '';
    ...
    function changeModule(moduleName, name, description) {
        ...
        document.getElementById('department_name2').value = name;
