                        ...
                        <div class="col-md-6">
                            ...
                            <select id="options" name="reviewer_id" class="form-control" required>
                                @foreach ($reviewer as $reviewers)
                                    <option value="{{ $reviewers->id }}"
                                        {{ $reviewers->id == $requisitionInfo->reviewed_by ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="options" name="approver_id" class="form-control" required>
                                @foreach ($approver as $approvers)
                                    <option value="{{ $approvers->id }}"
                                        {{ $approvers->id == $requisitionInfo->approved_by ? 'selected' : '' }}>
            ...
            <header>
                ...
                <div>
                    ...
                    <button class="btn btn-secondary" type="button"
                        onclick="document.getElementById('poForm').submit();">Update</button>
                    ...
                    @forelse ($requisitionInfo->requisitionDetails as $reqdetail)
                        <tr data-id="{{ $reqdetail->requisition_number }}">
                            ...
                            <td><input type="number" name="request_qty[]" class="form-control"
                                    value="{{ $reqdetail->qty }}" min="1" onchange="updateTotalPrice(this)"></td>
